...
//	        StandarizedApiExceptionResponse response = new StandarizedApiExceptionResponse("Error de validacion","error 01",ex.getClass().toString()+ ": ${spring.application.name} : Name of service not know");
//	        return new ResponseEntity(response, HttpStatus.PARTIAL_CONTENT);
//	    }
